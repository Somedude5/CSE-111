...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for element in symbol_quantity_list:
        ...
        symbol = symbol_quantity_list[element][NAME_INDEX]
        quantity = symbol_quantity_list[element][ATOMIC_MASS_INDEX]
        #   Get the atomic mass for the symbol.
        final = symbol * quantity
        return final
...
def main ():
    print("Welcome to the chemical formula converter thingy")
    # Get a chemical formula for a molecule from the user.
    formula = str(input("Enter the molecular formula of the sample: "))
    # Get a mass in grams from the user.
    amount = int(input("Enter the mass in grams of the sample"))
